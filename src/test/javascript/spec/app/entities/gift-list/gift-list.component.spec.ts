...
import { GiftListComponent } from 'app/entities/gift-list/gift-list.component';
...
describe('Component Tests', () => {
    describe('GiftList Management Component', () => {
        let comp: GiftListComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GiftListComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.giftLists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
