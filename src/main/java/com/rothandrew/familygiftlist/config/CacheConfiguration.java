...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("familygiftlist");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("familygiftlist");
        ...
        config.getMapConfigs().put("com.rothandrew.familygiftlist.domain.*", initializeDomainMapConfig(jHipsterProperties));
